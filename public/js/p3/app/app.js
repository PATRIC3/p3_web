    ...
    _doNavigation: function (newNavState) {
      ...
      if (newNavState.requireAuth && (window.App.authorizationToken === null || window.App.authorizationToken === undefined)) {
        ...
        var lp = new ContentPane({
          region: 'center',
          content: '<div style="text-align: center;width:100%;"><h3>Sign in</h3><p>This service requires authentication. Please <a class="showLoginWidget">login</a> or <a class="showRegWidget">register as a new user.</a></p>' +
