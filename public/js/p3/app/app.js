...
// 	var useridrow = '<tr class="uidheader"><th style="border:none">Email or Userid</th></tr><tr class="uidinput"><td>' +
// 	'<input class="userid" name="userid" style="width:300px;" value="" required></tr></td>';
// 	//let loginform = document.createElement('div');
// 	//loginform.className = 'LoginForm';
// 	var loginForm = '<h2 style="margin:0px;padding:4px;font-size:1.2em;text-align:center;background:#eee;"><span class="patric">PATRIC </span>User Login</h2>' +
...
// 	'<div><button style="margin-bottom:-22px;" type="button" class="regbutton loginbutton">Login</button>';
// 	//var loginButton = document.getElementsByClassName('loginbutton')[0];
// 	//loginButton.addEventListener('click', function(){console.log('howdy')});
// 	// +
// 	// '<button style="margin-top:34px" class="resetpass" type="button">Reset Password</button></div></div></form>';
// 	// +
...
// 	var loginForm = createLoginForm(appName, patric);
