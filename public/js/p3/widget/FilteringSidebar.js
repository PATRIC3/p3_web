define([
  ...
  'dijit/form/TextBox', './FilteringSidebarFacet', 'dojo/request', 'dojo/on',
  ...
  return declare([WidgetBase, Templated, WidgetsInTemplate], {
    ...
    templateString: `
      <div style="border-right: 2px solid #ddd; overflow-y: scroll;">
        ...
        <input type="text" name="searchFileds" value="Search fields..."
          ...
          data-dojo-props="trim:true" id="searchFiles" />
      </div>
    `,
    minimized: true,
    minSize: 52,
    ...
    _setFacetFieldsAttr: function (fields) {
      ...
      console.log('columns', ColumnsGenome);
    ...
    addCategory: function (name, values, minimized) {
      console.log('Add Category: ', name, minimized);
      var cs = [];
      if (this.selected) {
